      ...
      <div className="mx-auto max-w-7xl px-4 py-16 lg:px-8 lg:py-24">
        <div className="grid gap-12 lg:grid-cols-3">
          ...
          >
            ...
            <p className="mt-4 max-w-xs font-mono text-xs leading-relaxed text-muted-foreground">
              Probability + Perpetuals + Privacy.
              Trade with privacy. Secure by protocol.
            </p>
          </motion.div>
          ...
          >
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {["Avalanche", "Chainlink", "Threshold ECDSA", "AMM Pricing", "Privacy Vaults"].map(
                  (tech) => (
                    <span
                      key={tech}
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 sm:flex-row">
          <span className="font-mono text-[10px] text-muted-foreground">
            {"// "} Marshmallow Protocol &mdash; {new Date().getFullYear()}
          </span>
          <span className="font-mono text-[10px] text-muted-foreground">
            Encrypted markets. Perpetual precision. Private by design.
          </span>
        </div>
      </div>
    </footer>
